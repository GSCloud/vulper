...
Deploys basic containers *app*, *db*, *cache* _(Redis)_ and *phpmyadmin*
_(optional)_.

💡 Images, extensions, external binaries, ports and volumes are freely
configurable.
...
* `sudo apt install ruby-full` - Rusy is used for YAML 2 JSON
conversions only
